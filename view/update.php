...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $result = $jujutsuObj->updateJujutsu($jujutsuId, $name, $cursedTechnique, $domainExpansion, $type, $age);
...
$jujutsuObj = new Jujutsu();
$currentJujutsu = $jujutsuObj->getSorcererById($jujutsuId);
...
<head>
    ...
    <title>Edit Jujutsu Sorcerer</title>
    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <h1 class="title">EDIT JUJUTSU SORCERER</h1>
                <form class="login" id="form" onsubmit="return validateForm()" name="editForm"
                    action="update.php?id=<?php echo $jujutsuId; ?>" method="post">
                    <div class="login__field">
                        <label for="name">Name</label><br>
                        <input type="text" id="nameInput" name="name" class="login__input" placeholder="Name"
                            value="<?php echo $currentJujutsu['name']; ?>">
                    ...
                    <div class="login__field">
                        ...
                        <input type="text" name="cursed_technique" id="cursedTechniqueInput" class="login__input"
                            placeholder="Cursed Technique" value="<?php echo $currentJujutsu['cursed_technique']; ?>">
                    ...
                    <div class="login__field">
                        ...
                        <input type="checkbox" name="domain_expansion" id="domainExpansionInput" class="login__input"
                            <?php echo $currentJujutsu['domain_expansion'] ? 'checked' : ''; ?>>
                    </div>
                    <div class="login__field">
                        <label for="type">Type</label><br>
                        <select id="typeInput" name="type" class="login__input">
                            <option value="">Select Type</option>
                            <option value="human" <?php echo $currentJujutsu['type'] === 'human' ? 'selected' : ''; ?>>
                                Human</option>
                            <option value="cursed spirit" <?php echo $currentJujutsu['type'] === 'cursed spirit' ? 'selected' : ''; ?>>Cursed Spirit</option>
                        </select>
                    ...
                    <div class="login__field">
                        ...
                        <input type="text" name="age" id="ageInput" class="login__input" placeholder="Age"
                            value="<?php echo $currentJujutsu['age']; ?>">
